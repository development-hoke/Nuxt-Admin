...
import TopContentPickupSortTableRow from '@/components/molecules/table/TopContentPickupSortTableRow'
...
export default {
  name: 'TopContentPickupSortTable',
  ...
  methods: {
    async handleUpdateSort({ newIndex, oldIndex }) {
      ...
      try {
        ...
        await this.$store.dispatch('topContent/updatePickups', {
